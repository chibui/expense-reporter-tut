describe('persisting expenses', function () {
    ...
    describe('spy on', function () {
        ...
        it('should spy on persistingExpenses', inject(function (expensesDataService) {
        ...
        it('should spy on persistExpenses and fake a reply', inject(function (expensesDataService) {
            ...
            var numberExpensesPersisted = expensesDataService.persistExpenses();
            expect(numberExpensesPersisted).toEqual(3);
        }));
    })
});